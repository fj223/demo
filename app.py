...
EXCEL_PATH_DEFAULT = os.path.join(BASE_DIR, "ITsTiM_Raspisanie_2_polugodie_25-26_mag__pechat2.xlsx")
...
def teacher_schedule_pdf():
    ...
    try:
        ...
        return "服务器未安装 wkhtmltopdf，无法导出 PDF", 500

    pdf_file = BytesIO(pdf_bytes)
    return send_file(
        pdf_file,
        as_attachment=True,
        download_name=f"{name}_课程表.pdf",
